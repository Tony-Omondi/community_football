    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('official', 'League Official'), ('coach', 'Coach'), ('player', 'Player'), ('fan', 'Fan')], default='fan', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('team', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='coach', to='teams.team')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('overseeing_tournaments', models.ManyToManyField(blank=True, related_name='officials', to='tournaments.tournament')),
